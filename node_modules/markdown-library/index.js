import { Component, Directive, ElementRef, Inject, Injectable, NgModule, Pipe, ViewEncapsulation } from '@angular/core';
 ...
 */
var TemplateJsFunctionLoaderService = (function () {
    function TemplateJsFunctionLoaderService() {
    }
    /**
     * @param {?} scriptlink
     * @return {?}
     */
    TemplateJsFunctionLoaderService.prototype.createScript = /**
     * @param {?} scriptlink
     * @return {?}
     */
    function (scriptlink) {
        var /** @type {?} */ sNew = document.createElement("script");
        sNew.async = false;
        sNew.src = scriptlink;
        sNew.type = "text/javascript";
        var /** @type {?} */ s0 = document.getElementsByTagName('script')[0];
        if (!(typeof s0 === 'undefined' || s0.parentNode == null)) {
            s0.parentNode.insertBefore(sNew, s0);
        }
    };
    TemplateJsFunctionLoaderService.decorators = [
        { type: Injectable },
    ];
    /** @nocollapse */
    TemplateJsFunctionLoaderService.ctorParameters = function () { return []; };
    return TemplateJsFunctionLoaderService;
}());
...
var MarkdownModule = (function () {
    ...
    function () {
        return {
            ...
            providers: [MarkdownService, TemplateJsFunctionLoaderService]
        };
    };
...
export { MarkdownModule, MarkdownComponent, MarkdownDirective, MarkdownPipe, MarkdownService };
